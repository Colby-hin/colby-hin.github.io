...
const ALL_COMMANDS = [
  ...
  { label: "Open LinkedIn", href: "https://www.linkedin.com/in/colbyhinchy/", icon: "fa-brands fa-linkedin", meta: "External link" },
  { label: "Open Medium", href: "https://colbyhinchy.medium.com/", icon: "fa-brands fa-medium", meta: "External link" },
...
// Hide the Projects jump target while the projects list is empty.
const COMMANDS = ALL_COMMANDS.filter((c) => c.target !== "projects" || projects.length > 0);
