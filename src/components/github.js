  ...
  <div class="container">
    <div class="section-heading">
      ...
      <p class="section-subtitle" data-reveal>
        ...
        <a class="underline-link" href="${URLs.githubProfile}" target="_blank" rel="noopener noreferrer">github.com/colbyhinchy</a>.
      </p>
    </div>
    <div class="profile-stats-row" data-reveal>
      <div class="profile-card-shell glass tilt" data-github-card data-username="colbyhinchy">
    ...
    <figure class="contribution-graph glass" data-reveal>
      ...
      <img
        ...
        alt="GitHub contribution graph for colbyhinchy"
        loading="lazy"
        width="880"
        height="110"
      />
