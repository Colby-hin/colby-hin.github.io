...
export function mountProjects() {
  ...
  // No projects defined yet — hide the whole section instead of rendering a bare
  // heading over an empty grid. Add entries to `projects` in user-data/data.js
  // and the section (plus its nav + command-palette links) comes back automatically.
  if (!projects.length) {
