const githubUsername = "colbyhinchy";
const mediumUsername = "colbyhinchy";
...
// reject submissions whose Origin/Referer isn't colbyhinchy.github.io.
export const ALLOWED_HOSTNAMES = ["colbyhinchy.github.io", "localhost", "127.0.0.1"];
